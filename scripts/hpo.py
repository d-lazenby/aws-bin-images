...
def train(args, model, train_loader, valid_loader, loss_criterion, optimizer, device):
    best_loss = 1e6
...
def main():
    ...
    parser.add_argument("--train-proportion", type=float, default=0.5)
    ...
    optimizer = optim.Adam(model.fc.parameters(), lr=args.lr, betas=(args.beta1, 0.999), weight_decay=args.weight_decay)
